...
function processRawData(rows){
  ...
  var hhI=gc("hh Total"),m2I=gc("M2 Total"),mlI=gc("ml Total"),
      ppI=gc("Total Piezas Perforadas"),cepI=gc("Cantidad CEP"),
      unI=gc("Unidades Total"),cdI=gc("CODIGO"),ofI=gc("OF Asignada"),
      dtI=gc("FECHA ENTREGA"),
      yrI=gc("Ano|A\u00f1o|ANO|Year"),
      moI=gc("Mes|MES|Month"),
      wkI=gc("semana|Semana|SEMANA|Week"),
      descI=gc("DESCRIPCION|DESCRIPCION"),
      famI=gc("FAMILIA|familia"),
      catI=gc("Categoria Nivel 0|categoria nivel 0");
